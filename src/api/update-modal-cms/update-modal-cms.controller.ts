...
export class UpdateModalCMSController {
  ...
  @ApiBearerAuth()
  @Post('/')
  async createUpdateModal(
    // yg udh published di CMS, akan nge hit API ini dan UNEDITABLE. harus di delete and create new one
  ...
  @ApiBearerAuth()
  @Delete('/')
  async deleteUpdateModal(@Query() { id }: DeleteUpdateModalDto) {
